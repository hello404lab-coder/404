...
export function HeroSwooshes() {
  return (
    <>
      ...
      {/* Mobile - simplified centered version */}
      <svg
        aria-hidden="true"
        className="md:hidden absolute inset-0 w-full h-full"
        preserveAspectRatio="xMidYMid slice"
        viewBox="500 200 728 800"
        xmlns="http://www.w3.org/2000/svg"
      >
        <defs>
          <filter id="hero-blur-xl-mobile" x="-40%" y="-40%" width="180%" height="180%">
            <feGaussianBlur stdDeviation="18" />
          </filter>
          <filter id="hero-blur-lg-mobile" x="-40%" y="-40%" width="180%" height="180%">
            <feGaussianBlur stdDeviation="10" />
          </filter>
          <filter id="hero-blur-sm-mobile" x="-40%" y="-40%" width="180%" height="180%">
            <feGaussianBlur stdDeviation="4" />
          </filter>
        </defs>

        <g opacity="0.95" transform="translate(350 300) scale(0.5 0.5)">
          <AnimatedPath
            d="M-94 484C34 298 172 186 348 183C486 181 594 267 602 398C607 477 575 549 523 615"
            stroke="rgba(255,185,136,0.12)"
            strokeWidth={100}
            filter="url(#hero-blur-xl-mobile)"
            delay={0.2}
            duration={1.8}
          />
          <AnimatedPath
            ...
            stroke="rgba(255,244,239,0.9)"
            strokeWidth={15}
            filter="url(#hero-blur-lg-mobile)"
            delay={0.3}
            duration={1.6}
          />
          <AnimatedPath
            ...
            stroke="rgba(255,251,248,0.98)"
            strokeWidth={7}
            filter="url(#hero-blur-sm-mobile)"
            delay={0.4}
            duration={1.5}
          />
          <AnimatedPath
        ...
        <g opacity="0.95" transform="translate(1050 300) scale(-0.5 0.5)">
          <AnimatedPath
            d="M-94 484C34 298 172 186 348 183C486 181 594 267 602 398C607 477 575 549 523 615"
            stroke="rgba(135,46,255,0.62)"
            strokeWidth={84}
